            ...
            >
                <SwiperSlide className="main-slider__slide">
                    ...
                    <div className="main-slider__info">
                        <h3 className="main-slider__info-title">
                            Клубника в шоколаде
                        </h3>
                        <p className="main-slider__info-text">
                            Сладкие моменты для вас!
                        </p>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="main-slider__slide">
                    ...
                    <div className="main-slider__info">
                        ...
                        <p className="main-slider__info-text">
                            Милый тренд для особых моментов
                        </p>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="main-slider__slide">
                    <div className="main-slider__img">
                        <img src={slideAd3} alt="slide-img" />
                    </div>
                    <div className="main-slider__info">
                        <h3 className="main-slider__info-title">
                        ...
                        <p className="main-slider__info-text">
                            Идеал для любого праздника!
                        </p>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="main-slider__slide">
                    <div className="main-slider__img">
                        <img src={slideAd4} alt="slide-img" />
                    </div>
                    <div className="main-slider__info">
                        <h3 className="main-slider__info-title">
                            Только свежие цветы
                        ...
                        <p className="main-slider__info-text">
                            С лучших плантаций и проверенных поставщиков
                        </p>
                    </div>
                </SwiperSlide>
                <SwiperSlide className="main-slider__slide">
                    <div className="main-slider__img">
                        <img src={slideAd5} alt="slide-img" />
                    </div>
                    <div className="main-slider__info">
                        <h3 className="main-slider__info-title">
                            Быстрая доставка и яркие эмоции
                        </h3>
                        <p className="main-slider__info-text">
                            Подари незабываемые впечатления
                        </p>
                    </div>
                </SwiperSlide>
            </Swiper>
